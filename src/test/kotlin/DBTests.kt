...
class DBTests {
    ...
    fun sampleMapTest() {
        ...
        val anotherFilePath = "$mapsFolder/$anotherFileName.json"
    ...
    fun sampleTextureTest() {
        ...
        val fileName = UUID.randomUUID().toString()
        val filePath = "$texturesFolder/$fileName.png"
    ...
    fun sampleSessionTest() {
        ...
        try {
            ...
            assertTrue(DBOperator.setSessionInactive(sId2))
            assertFalse(DBOperator.getSessionByID(sId2)?.active ?: true)
            assertTrue(DBOperator.setSessionActive(sId2))
            assertTrue(DBOperator.getSessionByID(sId2)?.active ?: false)
